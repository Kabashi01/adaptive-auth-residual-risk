[Phase1] Final values (from get-value):
  Utility = 0.40589583333333334
  ResRisk = 0.46725
  TotalRisk = 0.5607
  Auth method : {'PinLeng': 0.0, 'PassStr': 0.0, 'OtpLeng': 0.0, 'Certificate': 0, 'SmartCard': 0, 'Token': 0, 'SignCryp': 0, 'GroupSign': 0, 'RingSign': 0, 'Iris': 0, 'Face': 1, 'Fingerprint': 0, 'TwoFactor': 0.0}
  Context : {'Location': 1.0, 'UnsecuredWiFi': 1.0, 'UnusualTime': 1.0, 'UnknownDevice': 1.0, 'PoorLighting': 0.0}
  
  
# Phase-2 Recommendations Report

Generated: 2026-02-01T10:38:00

## Config 1

- ResRisk: `0.4557`
- PImpersAttack: `0.6000`
- PSessionAttack: `0.4100`
