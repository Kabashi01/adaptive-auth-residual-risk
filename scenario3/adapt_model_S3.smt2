...
(assert (ite (> UnknownDevice 0)
  (and
    (>= ConfPriority 0.75)            ;; Personal or unmanaged devices are prone to data leakage — confidentiality is critical
    ...
    (= EfficPriority 0.6)            ;; Effort increased for verification on new device
...
(assert (ite (> UnsecuredWiFi 0)
     (and 
          (= ConfPriority 0.8)       ;; MITM attacks more likely — confidentiality at high risk
...
; --- Impersonation = 0.4  ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.6) (= PSessionAttack 0.61))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.4) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.38) (= PSessionAttack 0.61))
;   true))
...
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.5) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.48) (= PSessionAttack 0.61))
;   true))
...
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.7) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.68) (= PSessionAttack 0.61))
;   true))
...
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.8) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.78) (= PSessionAttack 0.61))
;   true))
...
; --- Session = 0.41 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.6) (= PSessionAttack 0.41))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.41))
;   true))

; ; --- Session = 0.51 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.6) (= PSessionAttack 0.51))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.51))
;   true))
...
; ; --- Session = 0.71 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.6) (= PSessionAttack 0.71))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.71))
;   true))

; ; --- Session = 0.81 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.6) (= PSessionAttack 0.81))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.6))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.81))
;   true))
...
; ; --- Replay = 0.4 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.4) (= PSessionAttack 0.61))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.4))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.61))
;   true))

; ; --- Replay = 0.5 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.5) (= PSessionAttack 0.61))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.5))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.61))
;   true))
...
; ; --- Replay = 0.7 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.7) (= PSessionAttack 0.61))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.7))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.61))
;   true))
...
; ; --- Replay = 0.8 ---
; (assert (ite (> UnsecuredWiFi 0)
;   (and (= PReplayAttack 0.8) (= PSessionAttack 0.61))
;   true))
; (assert (ite (> UnknownDevice 0)
;   (and (= PImpersAttack 0.6) (= PReplayAttack 0.8))
;   true))
; (assert (ite (> Location 0)
;   (and (>= PImpersAttack 0.58) (= PSessionAttack 0.61))
;   true))
