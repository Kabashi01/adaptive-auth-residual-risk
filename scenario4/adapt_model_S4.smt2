...
;; The Fourth scenario contextual factors
...
;; Impact of off-maintenance window
(assert
  (ite (> OffMainWindow 0)
       (and (>= ConfPriority 0.7)
            (>= AuthentPriority 0.75)
...
;; High-risk control operations enabled
(assert
  (ite (and (> SafetyLimits 0)
            (> ActuatorCommands 0)
            (> ControlParameters 0))
       (and (>= ConfPriority 0.8)
            (>= AuthentPriority 0.75)
            (>= IntegPriority 0.7))
       true))
