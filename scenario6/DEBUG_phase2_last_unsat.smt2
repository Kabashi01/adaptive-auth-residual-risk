...
;; -------------------------
;; The Sixth scenario contextual factors
...
(declare-fun OverrideSafetyLimits () Real)        ; O
...
(assert (and (<= 0 OverrideSafetyLimits) (<= OverrideSafetyLimits 1)))
...
(define-fun OptionalAllOff () Bool
  (and (= RunSystemSelfTests 0.0)
       (= ExportDownloadLogs 0.0)
       (= UploadFirmware 0.0)
       (= OverrideSafetyLimits 0.0)
       ))

; Enforce: Nice can be OFF only after all Optional are OFF
(assert (=> (= SwitchControlMode 0.0)     OptionalAllOff))
(assert (=> (= AdjustControlSetpoints 0.0)  OptionalAllOff))
(assert (=> (= RestartSubsystemController 0.0)  OptionalAllOff))
(assert (=> (= CalibrateSensorsRebaseline 0.0)  OptionalAllOff))
...
;; ------------------------------------------------------------
;; Maintenance Assets (Optional-level)
;; ------------------------------------------------------------
...
(assert (= AssetValue
  (+ (* SafetyLimits SafetyLimitsSensitivity 0.16)
     ...
     (* DiagnosticData DiagnosticDataSensitivity 0.08)
     (* CalibrationProfiles CalibrationProfilesSensitivity 0.08)
     (* SystemLogs SystemLogsSensitivity 0.08)
...
;; PoorLighting constraint example (keep if you want it in Phase-2)
...
(assert (= PImpers 0.6)) ; baseline


; ===== Knob 3: PSession (base 0.6) =====
(assert (= PSession 0.55)) ; baseline


; ===== Knob 4: PReplay (base 0.52) =====
(assert (= PReplay 0.86)) ; baseline
...
(assert (= OpPenaltyRaw
  (+ ;; MUST (high penalty if disabled)
     ...
     (* 0.4 (- 1.0 OverrideSafetyLimits))
)))

(declare-fun OpDisabledPenalty () Real)
(assert (= OpDisabledPenalty (_clamp01 (/ OpPenaltyRaw 7.3))))
...
(assert (< ResRisk 0.011573333333))
(assert (> ResRisk 0.0))
; --- BLOCKING CLAUSES (global enumeration) ---
(assert (or (not (= ViewSafetyStatusAndAlarms 1.0)) (not (= ViewDiagnostics 1.0)) (not (= AcknowledgeAlarms 1.0)) (not (= EmergencyShutdown 1.0)) (not (= SwitchControlMode 1.0)) (not (= AdjustControlSetpoints 1.0)) (not (= RestartSubsystemController 1.0)) (not (= CalibrateSensorsRebaseline 0.000191428573)) (not (= RunSystemSelfTests 0.000191428573)) (not (= ExportDownloadLogs 1.0)) (not (= UploadFirmware 1.0)) (not (= OverrideSafetyLimits 1.0)) (not SafetyLimits_Read) (not SafetyLimits_Write) SafetyLimits_Update SafetyLimits_Delete (not AlarmRules_Read) (not AlarmRules_Write) (not AlarmRules_Update) (not AlarmRules_Delete) (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) (not SystemLogs_Delete) (not ControllerConfiguration_Read) (not ControllerConfiguration_Write) (not ControllerConfiguration_Update) (not ControllerConfiguration_Delete) (not ControlParameters_Read) (not ControlParameters_Write) (not ControlParameters_Update) (not ControlParameters_Delete) (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) (not ActuatorCommands_Delete) CalibrationProfiles_Read (not CalibrationProfiles_Write) CalibrationProfiles_Update CalibrationProfiles_Delete (not MaintenanceRecords_Read) (not MaintenanceRecords_Write) (not MaintenanceRecords_Update) (not MaintenanceRecords_Delete) (not FirmwareImages_Read) (not FirmwareImages_Write) (not FirmwareImages_Update) (not FirmwareImages_Delete)))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.978464285714)) (not (= ViewDiagnostics 0.978464285714)) (not (= AcknowledgeAlarms 0.978464285714)) (not (= EmergencyShutdown 0.978464285714)) (not (= SwitchControlMode 0.978464285714)) (not (= AdjustControlSetpoints 0.978464285714)) (not (= RestartSubsystemController 0.978464285714)) (not (= CalibrateSensorsRebaseline 0.021535714286)) (not (= RunSystemSelfTests 0.021535714286)) (not (= ExportDownloadLogs 0.978464285714)) (not (= UploadFirmware 0.978464285714)) (not (= OverrideSafetyLimits 0.978464285714)) (not SafetyLimits_Read) (not SafetyLimits_Write) (not SafetyLimits_Update) SafetyLimits_Delete (not AlarmRules_Read) (not AlarmRules_Write) (not AlarmRules_Update) AlarmRules_Delete (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) (not SystemLogs_Delete) (not ControllerConfiguration_Read) (not ControllerConfiguration_Write) (not ControllerConfiguration_Update) (not ControllerConfiguration_Delete) (not ControlParameters_Read) (not ControlParameters_Write) ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) (not ActuatorCommands_Delete) CalibrationProfiles_Read (not CalibrationProfiles_Write) CalibrationProfiles_Update CalibrationProfiles_Delete (not MaintenanceRecords_Read) (not MaintenanceRecords_Write) (not MaintenanceRecords_Update) (not MaintenanceRecords_Delete) (not FirmwareImages_Read) (not FirmwareImages_Write) (not FirmwareImages_Update) FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.995692857144)) (not (= ViewDiagnostics 0.995692857144)) (not (= AcknowledgeAlarms 0.995692857144)) (not (= EmergencyShutdown 0.995692857144)) (not (= SwitchControlMode 0.995692857144)) (not (= AdjustControlSetpoints 0.995692857144)) (not (= RestartSubsystemController 0.995692857144)) (not (= CalibrateSensorsRebaseline 0.010767857143)) (not (= RunSystemSelfTests 0.008784318815)) (not (= ExportDownloadLogs 0.995692857144)) (not (= UploadFirmware 0.995692857144)) (not (= OverrideSafetyLimits 0.995692857144)) (not SafetyLimits_Read) SafetyLimits_Write SafetyLimits_Update SafetyLimits_Delete (not AlarmRules_Read) (not AlarmRules_Write) AlarmRules_Update AlarmRules_Delete (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) (not SystemLogs_Delete) (not ControllerConfiguration_Read) (not ControllerConfiguration_Write) (not ControllerConfiguration_Update) ControllerConfiguration_Delete (not ControlParameters_Read) (not ControlParameters_Write) ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) (not ActuatorCommands_Delete) CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update (not CalibrationProfiles_Delete) (not MaintenanceRecords_Read) MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete (not FirmwareImages_Read) (not FirmwareImages_Write) (not FirmwareImages_Update) (not FirmwareImages_Delete)))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.978464285714)) (not (= ViewDiagnostics 0.978464285714)) (not (= AcknowledgeAlarms 0.978464285714)) (not (= EmergencyShutdown 0.978464285714)) (not (= SwitchControlMode 0.021535714286)) (not (= AdjustControlSetpoints 0.021535714286)) (not (= RestartSubsystemController 0.021535714286)) (not (= CalibrateSensorsRebaseline 0.021535714286)) (not (= RunSystemSelfTests 0.016510714285)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.016510714285)) (not (= OverrideSafetyLimits 0.016510714285)) (not SafetyLimits_Read) (not SafetyLimits_Write) SafetyLimits_Update SafetyLimits_Delete (not AlarmRules_Read) AlarmRules_Write AlarmRules_Update AlarmRules_Delete (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) SystemLogs_Delete (not ControllerConfiguration_Read) (not ControllerConfiguration_Write) ControllerConfiguration_Update ControllerConfiguration_Delete (not ControlParameters_Read) (not ControlParameters_Write) (not ControlParameters_Update) (not ControlParameters_Delete) (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update (not CalibrationProfiles_Delete) MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete (not FirmwareImages_Read) (not FirmwareImages_Write) FirmwareImages_Update FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.9921875)) (not (= ViewDiagnostics 0.75)) (not (= AcknowledgeAlarms 0.984375)) (not (= EmergencyShutdown 0.875)) (not (= SwitchControlMode 0.0)) (not (= AdjustControlSetpoints 0.0)) (not (= RestartSubsystemController 0.997767857143)) (not (= CalibrateSensorsRebaseline 0.021535714286)) (not (= RunSystemSelfTests 0.0)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.0)) (not (= OverrideSafetyLimits 0.0)) (not SafetyLimits_Read) (not SafetyLimits_Write) (not SafetyLimits_Update) (not SafetyLimits_Delete) (not AlarmRules_Read) (not AlarmRules_Write) (not AlarmRules_Update) (not AlarmRules_Delete) (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) (not SystemLogs_Delete) (not ControllerConfiguration_Read) ControllerConfiguration_Write ControllerConfiguration_Update ControllerConfiguration_Delete ControlParameters_Read ControlParameters_Write ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) (not ActuatorCommands_Delete) CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update (not CalibrationProfiles_Delete) MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.99609375)) (not (= ViewDiagnostics 0.5)) (not (= AcknowledgeAlarms 0.5)) (not (= EmergencyShutdown 0.9921875)) (not (= SwitchControlMode 0.0)) (not (= AdjustControlSetpoints 0.875)) (not (= RestartSubsystemController 0.998883928571)) (not (= CalibrateSensorsRebaseline 0.021535714286)) (not (= RunSystemSelfTests 0.0)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.0)) (not (= OverrideSafetyLimits 0.0)) (not SafetyLimits_Read) (not SafetyLimits_Write) (not SafetyLimits_Update) (not SafetyLimits_Delete) (not AlarmRules_Read) (not AlarmRules_Write) (not AlarmRules_Update) AlarmRules_Delete (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) SystemLogs_Update SystemLogs_Delete (not ControllerConfiguration_Read) ControllerConfiguration_Write ControllerConfiguration_Update ControllerConfiguration_Delete (not ControlParameters_Read) (not ControlParameters_Write) (not ControlParameters_Update) ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update (not CalibrationProfiles_Delete) MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.978464285714)) (not (= ViewDiagnostics 0.478464285714)) (not (= AcknowledgeAlarms 0.478464285714)) (not (= EmergencyShutdown 0.978464285714)) (not (= SwitchControlMode 0.0)) (not (= AdjustControlSetpoints 0.0)) (not (= RestartSubsystemController 0.978464285714)) (not (= CalibrateSensorsRebaseline 0.021535714286)) (not (= RunSystemSelfTests 0.0)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.0)) (not (= OverrideSafetyLimits 0.0)) (not SafetyLimits_Read) (not SafetyLimits_Write) (not SafetyLimits_Update) (not SafetyLimits_Delete) (not AlarmRules_Read) (not AlarmRules_Write) (not AlarmRules_Update) (not AlarmRules_Delete) (not DiagnosticData_Read) (not DiagnosticData_Write) (not DiagnosticData_Update) (not DiagnosticData_Delete) (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) SystemLogs_Delete (not ControllerConfiguration_Read) (not ControllerConfiguration_Write) (not ControllerConfiguration_Update) (not ControllerConfiguration_Delete) ControlParameters_Read ControlParameters_Write ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) ActuatorCommands_Update ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update CalibrationProfiles_Delete MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.956928571428)) (not (= ViewDiagnostics 0.456928571428)) (not (= AcknowledgeAlarms 0.456928571428)) (not (= EmergencyShutdown 0.956928571428)) (not (= SwitchControlMode 0.0)) (not (= AdjustControlSetpoints 0.0)) (not (= RestartSubsystemController 0.978464285714)) (not (= CalibrateSensorsRebaseline 0.021535714286)) (not (= RunSystemSelfTests 0.0)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.0)) (not (= OverrideSafetyLimits 0.0)) (not SafetyLimits_Read) SafetyLimits_Write SafetyLimits_Update SafetyLimits_Delete (not AlarmRules_Read) AlarmRules_Write AlarmRules_Update AlarmRules_Delete (not DiagnosticData_Read) DiagnosticData_Write DiagnosticData_Update DiagnosticData_Delete (not SystemLogs_Read) (not SystemLogs_Write) SystemLogs_Update SystemLogs_Delete (not ControllerConfiguration_Read) (not ControllerConfiguration_Write) (not ControllerConfiguration_Update) (not ControllerConfiguration_Delete) ControlParameters_Read ControlParameters_Write ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) ActuatorCommands_Update ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update CalibrationProfiles_Delete MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 0.875)) (not (= ViewDiagnostics 0.25)) (not (= AcknowledgeAlarms 0.25)) (not (= EmergencyShutdown 0.925)) (not (= SwitchControlMode 0.0)) (not (= AdjustControlSetpoints 0.0)) (not (= RestartSubsystemController 0.0)) (not (= CalibrateSensorsRebaseline 0.010767857143)) (not (= RunSystemSelfTests 0.0)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.0)) (not (= OverrideSafetyLimits 0.0)) (not SafetyLimits_Read) (not SafetyLimits_Write) SafetyLimits_Update SafetyLimits_Delete (not AlarmRules_Read) AlarmRules_Write AlarmRules_Update AlarmRules_Delete (not DiagnosticData_Read) DiagnosticData_Write DiagnosticData_Update DiagnosticData_Delete (not SystemLogs_Read) (not SystemLogs_Write) (not SystemLogs_Update) SystemLogs_Delete ControllerConfiguration_Read ControllerConfiguration_Write ControllerConfiguration_Update ControllerConfiguration_Delete ControlParameters_Read ControlParameters_Write ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) (not ActuatorCommands_Write) (not ActuatorCommands_Update) ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update CalibrationProfiles_Delete MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete))
(assert (or (not (= ViewSafetyStatusAndAlarms 1.0)) (not (= ViewDiagnostics 1.0)) (not (= AcknowledgeAlarms 1.0)) (not (= EmergencyShutdown 1.0)) (not (= SwitchControlMode 0.0)) (not (= AdjustControlSetpoints 0.0)) (not (= RestartSubsystemController 0.0)) (not (= CalibrateSensorsRebaseline 0.001116071428)) (not (= RunSystemSelfTests 0.0)) (not (= ExportDownloadLogs 0.0)) (not (= UploadFirmware 0.0)) (not (= OverrideSafetyLimits 0.0)) (not SafetyLimits_Read) (not SafetyLimits_Write) (not SafetyLimits_Update) SafetyLimits_Delete (not AlarmRules_Read) AlarmRules_Write AlarmRules_Update AlarmRules_Delete (not DiagnosticData_Read) DiagnosticData_Write DiagnosticData_Update DiagnosticData_Delete (not SystemLogs_Read) (not SystemLogs_Write) SystemLogs_Update SystemLogs_Delete ControllerConfiguration_Read ControllerConfiguration_Write ControllerConfiguration_Update ControllerConfiguration_Delete ControlParameters_Read ControlParameters_Write ControlParameters_Update ControlParameters_Delete (not ActuatorCommands_Read) ActuatorCommands_Write ActuatorCommands_Update ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update CalibrationProfiles_Delete MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete))

(check-sat)
(get-value (ResRisk AssetValue AuthorizationPenalty PermPenalty ViewSafetyStatusAndAlarms ViewDiagnostics AcknowledgeAlarms EmergencyShutdown SwitchControlMode AdjustControlSetpoints RestartSubsystemController CalibrateSensorsRebaseline RunSystemSelfTests ExportDownloadLogs UploadFirmware OverrideSafetyLimits SafetyLimits_Read SafetyLimits_Write SafetyLimits_Update SafetyLimits_Delete AlarmRules_Read AlarmRules_Write AlarmRules_Update AlarmRules_Delete DiagnosticData_Read DiagnosticData_Write DiagnosticData_Update DiagnosticData_Delete SystemLogs_Read SystemLogs_Write SystemLogs_Update SystemLogs_Delete ControllerConfiguration_Read ControllerConfiguration_Write ControllerConfiguration_Update ControllerConfiguration_Delete ControlParameters_Read ControlParameters_Write ControlParameters_Update ControlParameters_Delete ActuatorCommands_Read ActuatorCommands_Write ActuatorCommands_Update ActuatorCommands_Delete CalibrationProfiles_Read CalibrationProfiles_Write CalibrationProfiles_Update CalibrationProfiles_Delete MaintenanceRecords_Read MaintenanceRecords_Write MaintenanceRecords_Update MaintenanceRecords_Delete FirmwareImages_Read FirmwareImages_Write FirmwareImages_Update FirmwareImages_Delete SafetyLimits AlarmRules DiagnosticData SystemLogs ControllerConfiguration ControlParameters ActuatorCommands CalibrationProfiles MaintenanceRecords FirmwareImages PRiskPImpersAttack PRiskReplayAttack PRiskSessionAttack TotalRisk PImpersAttack PReplayAttack PSessionAttack FPImpersAttack FPReplayAttack FPSessionAttack))
