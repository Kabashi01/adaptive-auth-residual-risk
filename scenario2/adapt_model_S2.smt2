...
(assert (ite (> Location 0)  
     (and 
        (> ConfPriority 0.6)         ;; Location can increase confidentiality priority
        (> AuthentPriority  0.6)      ;; Unusual location may suggest impersonation attempt — raises authenticity priority
...
(assert (ite (> Emergency 0)
     (and 
        ...
        (> AuthentPriority  0.6)     ;; Abnormal access time suggests possible impersonation — authenticity rises
...
(assert (ite (> UnsecuredWiFi 0)
     (and 
          ...
          (> EffectPriority 0.55)      ;; Slight usability impact from fallback to safer methods
          (> EfficPriority 0.6)      ;; 
